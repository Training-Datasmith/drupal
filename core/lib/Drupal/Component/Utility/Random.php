...
class Random
{
     ...
     * @see \Drupal\Component\Utility\Random::string()
     */
    public function machine_name(int $length = 8, bool $unique = false): string
    {
        ...
        do {
            ...
            $counter++;
        } while ($unique && isset($this->machine_names[$str]));
        if ($unique) {
            $this->machine_names[$str] = true;
        }
        return $str;
    }
    /**
    ...
    {
        $vowels = ['a', 'e', 'i', 'o', 'u'];
        $cons = ['b', 'c', 'd', 'g', 'h', 'j', 'k', 'l', 'm', 'n', 'p', 'r', 's', 't', 'u', 'v', 'w', 'tr', 'cr', 'br', 'fr', 'th', 'dr', 'ch', 'ph', 'wr', 'st', 'sp', 'sw', 'pr', 'sl', 'cl', 'sh'];
