...
class Unicode
{
     ...
     */
    public static function encoding_from_bom($data)
    {
        static $bom_map = ["﻿" => 'UTF-8', "\xfe\xff" => 'UTF-16BE', "\xff\xfe" => 'UTF-16LE', "\x00\x00\xfe\xff" => 'UTF-32BE', "\xff\xfe\x00\x00" => 'UTF-32LE', "+/v8" => 'UTF-7', "+/v9" => 'UTF-7', "+/v+" => 'UTF-7', "+/v/" => 'UTF-7', "+/v8-" => 'UTF-7'];
     ...
     */
    public static function convert_to_utf8($data, $encoding): string|false
    {
     ...
     */
    public static function truncate_bytes($string, $len)
    {
