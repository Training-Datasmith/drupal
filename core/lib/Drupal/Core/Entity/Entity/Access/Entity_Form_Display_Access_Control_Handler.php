 ...
 */
class Entity_Form_Display_Access_Control_Handler extends Entity_Access_Control_Handler
{
    /**
     * {@inheritdoc}
     */
    protected function check_access(Entity_Interface $entity, $operation, Account_Interface $account)
    {
        ...
        return parent::check_access($entity, $operation, $account)->or_if(Access_Result::allowed_if_has_permission($account, 'administer ' . $entity->get_target_entity_type_id() . ' form display'));
    }
}