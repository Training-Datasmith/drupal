...
class Checkbox extends FormElementBase {
   ...
   */
  public static function preRenderCheckbox(array $element): array {
   ...
   */
  public static function processCheckbox(array &$element, FormStateInterface $form_state, &$complete_form): array {
    $value = $element['#value'];
