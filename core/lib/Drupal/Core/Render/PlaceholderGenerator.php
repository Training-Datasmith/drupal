...
class PlaceholderGenerator implements PlaceholderGeneratorInterface
{
     ...
     */
    public function __construct(protected \Drupal\Core\Cache\Context\CacheContextsManager $cacheContextsManager, protected array $rendererConfig)
    {
    }
     ...
     * {@inheritdoc}
     */
    public function canCreatePlaceholder(array $element): bool
    {
     ...
     * {@inheritdoc}
     */
    public function shouldAutomaticallyPlaceholder(array $element): bool
    {
     ...
     * {@inheritdoc}
     */
    public function createPlaceholder(array $element): array
    {
