    ...
    public function validate($module): array
    {
        ...
        if ($module === $this->installProfile) {
            ...
            if (!empty($profile_only_modules)) {
                $reasons[] = $this->t(
                    "The install profile '@profile_name' is providing the following module(s): @profile_modules",
            ...
            if (!empty($profile_only_themes)) {
                $reasons[] = $this->t(
                    "The install profile '@profile_name' is providing the following theme(s): @profile_themes",
            ...
            if (isset($extension->required_by[$this->installProfile])) {
                ...
                $reasons[] = $this->t(
                    "The '@profile_name' install profile requires '@module_name'",
