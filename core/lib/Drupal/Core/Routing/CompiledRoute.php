...
class CompiledRoute extends SymfonyCompiledRoute {
   ...
   */
  protected $fit, $pattern_outline, /**
   * The number of parts in the path of this route.
   */
  protected $numParts, $staticPrefix, $regex, array $tokens, array $pathVariables, $hostRegex = NULL, array $hostTokens = [], array $hostVariables = [], array $variables = []) {
