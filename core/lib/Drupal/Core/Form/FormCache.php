...
class FormCache implements FormCacheInterface {
   ...
   * The app root.
   */
  protected $root, protected \Drupal\Core\KeyValueStore\KeyValueExpirableFactoryInterface $keyValueExpirableFactory, protected \Drupal\Core\Extension\ModuleHandlerInterface $moduleHandler, protected \Drupal\Core\Session\AccountInterface $currentUser, protected \Drupal\Core\Access\CsrfTokenGenerator $csrfToken, /**
   * Logger channel.
   */
  protected \Psr\Log\LoggerInterface $logger, RequestStack $request_stack, protected \Drupal\Core\PageCache\RequestPolicyInterface $requestPolicy) {
