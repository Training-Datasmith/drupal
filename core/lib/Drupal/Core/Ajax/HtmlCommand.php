 ...
 * @ingroup ajax
 */
class Html_Command extends Insert_Command
{
    /**
    ...
    {
        return ['command' => 'insert', 'method' => 'html', 'selector' => $this->selector, 'data' => $this->get_rendered_content(), 'settings' => $this->settings];
    }
}