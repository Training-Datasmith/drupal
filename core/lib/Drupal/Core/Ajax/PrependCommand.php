 ...
 * @ingroup ajax
 */
class Prepend_Command extends Insert_Command
{
    /**
    ...
    {
        return ['command' => 'insert', 'method' => 'prepend', 'selector' => $this->selector, 'data' => $this->get_rendered_content(), 'settings' => $this->settings];
    }
}