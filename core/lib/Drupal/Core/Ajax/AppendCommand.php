 ...
 * @ingroup ajax
 */
class Append_Command extends Insert_Command
{
    /**
    ...
    {
        return ['command' => 'insert', 'method' => 'append', 'selector' => $this->selector, 'data' => $this->get_rendered_content(), 'settings' => $this->settings];
    }
}