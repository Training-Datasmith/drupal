 ...
 * @ingroup ajax
 */
class After_Command extends Insert_Command
{
    /**
    ...
    {
        return ['command' => 'insert', 'method' => 'after', 'selector' => $this->selector, 'data' => $this->get_rendered_content(), 'settings' => $this->settings];
    }
}