...
class Drupal
{
     ...
     */
    public const MINIMUM_PHP = '8.5.0';
     ...
     */
    public const RECOMMENDED_PHP = '8.5';
     ...
     */
    public const TRANSLATION_DEFAULT_SERVER_PATTERN = 'https://ftp.drupal.org/files/translations/%core/%project/%project-%version.%language.po';
