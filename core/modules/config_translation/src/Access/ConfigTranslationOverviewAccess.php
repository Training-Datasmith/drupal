...
class ConfigTranslationOverviewAccess implements AccessInterface
{
     ...
     */
    public function __construct(protected \Drupal\config_translation\ConfigMapperManagerInterface $configMapperManager, protected \Drupal\Core\Language\LanguageManagerInterface $languageManager)
    {
    }
