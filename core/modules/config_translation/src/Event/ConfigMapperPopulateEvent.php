...
class ConfigMapperPopulateEvent extends Event
{
     ...
     */
    public function __construct(protected \Drupal\config_translation\ConfigMapperInterface $mapper, protected \Drupal\Core\Routing\RouteMatchInterface $routeMatch)
    {
    }
