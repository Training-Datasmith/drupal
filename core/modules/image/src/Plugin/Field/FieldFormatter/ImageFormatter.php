...
class ImageFormatter extends ImageFormatterBase {
   ...
   */
  public function __construct($plugin_id, $plugin_definition, FieldDefinitionInterface $field_definition, array $settings, $label, $view_mode, array $third_party_settings, protected \Drupal\Core\Session\AccountInterface $currentUser, /**
   * The image style entity storage.
   */
  protected \Drupal\Core\Entity\EntityStorageInterface $imageStyleStorage, protected \Drupal\Core\File\FileUrlGeneratorInterface $fileUrlGenerator) {
