...
class ImageEffectManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/ImageEffect', $namespaces, $module_handler, ImageEffectInterface::class, ImageEffect::class, \Drupal\image\Annotation\ImageEffect::class);
