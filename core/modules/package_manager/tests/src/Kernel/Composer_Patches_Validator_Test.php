...
class ComposerPatchesValidatorTest extends PackageManagerKernelTestBase
{
    ...
    public const CONFIG_ALLOWED_PLUGIN = 1;
    public const EXTRA_EXIT_ON_PATCH_FAILURE = 2;
    public const REQUIRE_PACKAGE_FROM_ROOT = 4;
    public const REQUIRE_PACKAGE_INDIRECTLY = 8;
