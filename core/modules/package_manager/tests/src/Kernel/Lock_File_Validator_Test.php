...
class LockFileValidatorTest extends PackageManagerKernelTestBase
{
    ...
    public function testLockFileChanged(string $event_class): void
    {
        ...
        $result = ValidationResult::createError([
          $this->t(
              'Unexpected changes were detected in the active lock file (@file), which indicates that other Composer operations were performed since this Package Manager operation started. This can put the code base into an unreliable state and therefore is not allowed.',
