...
class LayoutBuilderSampleEntityGenerator implements SampleEntityGeneratorInterface {
   ...
   */
  public function __construct(protected \Drupal\Core\TempStore\SharedTempStoreFactory $tempStoreFactory, protected \Drupal\Core\Entity\EntityTypeManagerInterface $entityTypeManager)
  {
  }
   ...
   * {@inheritdoc}
   */
  public function delete($entity_type_id, $bundle_id): static {
    $tempstore = $this->tempStoreFactory->get('layout_builder.sample_entity');
