...
class ModerationStateConstraintValidator extends ConstraintValidator implements ContainerInjectionInterface
{
     ...
     */
    public function __construct(protected \Drupal\content_moderation\ModerationInformationInterface $moderationInformation, protected \Drupal\Core\Session\AccountInterface $currentUser, protected \Drupal\content_moderation\StateTransitionValidationInterface $stateTransitionValidation)
    {
    }
