...
class CKEditor5MediaAndFilterSettingsInSyncConstraintValidator extends ConstraintValidator implements ContainerInjectionInterface {
   ...
   */
  public function __construct(protected \Drupal\filter\FilterPluginManager $filterPluginManager, protected \Drupal\Core\Config\TypedConfigManagerInterface $typedConfigManager)
  {
  }
