...
class NodeAdminRouteSubscriber extends RouteSubscriberBase {
   ...
   */
  public function __construct(protected \Drupal\Core\Config\ConfigFactoryInterface $configFactory, protected \Drupal\Core\Routing\RouteBuilderInterface $routerBuilder)
  {
  }
