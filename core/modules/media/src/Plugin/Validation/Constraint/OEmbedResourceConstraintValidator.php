...
class OEmbedResourceConstraintValidator extends ConstraintValidator implements ContainerInjectionInterface {
   ...
   *   The logger service.
   */
  public function __construct(protected \Drupal\media\OEmbed\UrlResolverInterface $urlResolver, protected \Drupal\media\OEmbed\ResourceFetcherInterface $resourceFetcher, LoggerChannelFactoryInterface $logger_factory) {
