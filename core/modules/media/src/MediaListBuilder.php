...
class MediaListBuilder extends EntityListBuilder {
   ...
   */
  protected bool $thumbnailStyleExists;
   ...
   */
  public function __construct(EntityTypeInterface $entity_type, EntityStorageInterface $storage, protected \Drupal\Core\Datetime\DateFormatterInterface $dateFormatter, protected \Drupal\Core\Language\LanguageManagerInterface $languageManager, EntityStorageInterface $image_style_storage) {
