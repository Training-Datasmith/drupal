...
abstract class SettingsTrayTestBase extends OffCanvasTestBase
{
    ...
    public const TOOLBAR_EDIT_LINK_SELECTOR = '#toolbar-bar div.contextual-toolbar-tab button';

    public const LABEL_INPUT_SELECTOR = 'input[data-drupal-selector="edit-settings-label"]';
