...
final class JsonApiFilter
{
     ...
     */
    public const AMONG_ALL = 'filter_among_all';
     ...
     * @see hook_jsonapi_ENTITY_TYPE_filter_access()
     */
    public const AMONG_PUBLISHED = 'filter_among_published';
     ...
     * @see hook_jsonapi_ENTITY_TYPE_filter_access()
     */
    public const AMONG_ENABLED = 'filter_among_enabled';
     ...
     * @see hook_jsonapi_ENTITY_TYPE_filter_access()
     */
    public const AMONG_OWN = 'filter_among_own';
