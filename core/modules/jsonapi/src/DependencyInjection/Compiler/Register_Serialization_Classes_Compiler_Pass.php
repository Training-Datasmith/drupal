...
class RegisterSerializationClassesCompilerPass extends DrupalRegisterSerializationClassesCompilerPass
{
     ...
     * @const string
     */
    public const OVERRIDDEN_SERVICE_ID = 'jsonapi.serializer';
     ...
     * @const string
     */
    public const OVERRIDDEN_SERVICE_NORMALIZER_TAG = 'jsonapi_normalizer';
     ...
     * @const string
     */
    public const OVERRIDDEN_SERVICE_ENCODER_TAG = 'jsonapi_encoder';
