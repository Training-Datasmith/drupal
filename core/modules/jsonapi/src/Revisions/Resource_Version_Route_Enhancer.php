...
final class ResourceVersionRouteEnhancer implements EnhancerInterface
{
     ...
     * @var string
     */
    public const REVISION_ID_KEY = 'revision_id';
     ...
     * @var string
     */
    public const RESOURCE_VERSION_QUERY_PARAMETER = 'resourceVersion';
     ...
     * @var string
     */
    public const WORKING_COPIES_REQUESTED = 'working_copies_requested';
     ...
     */
    public const CACHE_CONTEXT = 'url.query_args:resourceVersion';
     ...
     */
    public const VERSION_IDENTIFIER_VALIDATOR = '/^[a-z]+[a-z_]*[a-z]+:[a-zA-Z0-9\-]+(:[a-zA-Z0-9\-]+)*$/';
