...
class JsonApiSpec
{
     ...
     */
    public const SUPPORTED_SPECIFICATION_VERSION = '1.1';

    /**
     * The URI of the supported specification document.
     */
    public const SUPPORTED_SPECIFICATION_PERMALINK = 'https://jsonapi.org/format/1.1/';

    /**
     * The URI of the supported specification's JSON Schema.
     */
    public const SUPPORTED_SPECIFICATION_JSON_SCHEMA = 'https://jsonapi.org/schemas/spec/v1.1/draft';
     ...
     */
    public const MEMBER_NAME_GLOBALLY_ALLOWED_CHARACTER_CLASS = '[a-zA-Z0-9\x{80}-\x{10FFFF}]';
     ...
     * @see http://php.net/manual/en/regexp.reference.character-classes.php
     */
    public const MEMBER_NAME_INNER_ALLOWED_CHARACTERS = "[a-zA-Z0-9\x{80}-\x{10FFFF}\-_ ]";

    /**
     * Regular expression to check the validity of a member name.
     */
    public const MEMBER_NAME_REGEXP = '/^' .
     ...
     */
    public static function isValidMemberName($member_name): bool
    {
     ...
     */
    public const RESERVED_QUERY_PARAMETERS = [
      'filter',
      'sort',
      'page',
      'fields',
     ...
     * @var string
     */
    public const VERSION_QUERY_PARAMETER = 'resourceVersion';
     ...
     */
    public static function isValidCustomQueryParameter($custom_query_parameter_name): bool
    {
