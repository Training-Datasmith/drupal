...
interface MigrationInterface extends PluginInspectionInterface, DerivativeInspectionInterface
{
     ...
     */
    public const STATUS_ROLLING_BACK = 2;
     ...
     * Migration warning.
     */
    public const MESSAGE_WARNING = 2;
     ...
     * Migration info.
     */
    public const MESSAGE_INFORMATIONAL = 4;
     ...
     */
    public const RESULT_INCOMPLETE = 2;

    /**
     * The process was stopped externally (e.g., via drush migrate-stop).
     */
    public const RESULT_STOPPED = 3;
     ...
     */
    public const RESULT_SKIPPED = 5;

    /**
     * This migration is disabled, skipping.
     */
    public const RESULT_DISABLED = 6;
