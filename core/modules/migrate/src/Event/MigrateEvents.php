...
final class MigrateEvents
{
     ...
     * @var string
     */
    public const MAP_SAVE = 'migrate.map_save';
     ...
     * @var string
     */
    public const MAP_DELETE = 'migrate.map_delete';
     ...
     * @var string
     */
    public const PRE_IMPORT = 'migrate.pre_import';
     ...
     * @var string
     */
    public const POST_IMPORT = 'migrate.post_import';
     ...
     * @var string
     */
    public const PRE_ROW_SAVE = 'migrate.pre_row_save';
     ...
     * @var string
     */
    public const POST_ROW_SAVE = 'migrate.post_row_save';
     ...
     * @var string
     */
    public const PRE_ROLLBACK = 'migrate.pre_rollback';
     ...
     * @var string
     */
    public const POST_ROLLBACK = 'migrate.post_rollback';
     ...
     * @var string
     */
    public const PRE_ROW_DELETE = 'migrate.pre_row_delete';
     ...
     * @var string
     */
    public const POST_ROW_DELETE = 'migrate.post_row_delete';
     ...
     * @var string
     */
    public const IDMAP_MESSAGE = 'migrate.idmap_message';
