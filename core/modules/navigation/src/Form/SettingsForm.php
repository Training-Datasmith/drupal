        ...
        if ($form_state->getValue('logo_provider') !== NavigationRenderer::LOGO_PROVIDER_CUSTOM) {
            ...
            if ($file) {
                ...
                if (!$logo_dimensions) {
                    ...
                    $form_state->setErrorByName('logo_upload', $this->t(
                        'Image dimensions are bigger than the expected %widthx%height pixels and cannot be used as the navigation logo.',
                        [
                        '%width' => $width,
                        '%height' => $height,
            ]
            ...
            if (!empty($values['logo_upload'])) {
                ...
                if ($values['logo_dimensions']['resize']) {
                    ...
                    $this->messenger()->addStatus($this->t(
                        'The image was resized to fit within the navigation logo expected dimensions of %widthx%height pixels. The new dimensions of the resized image are %new_widthx%new_height pixels.',
                        [
                        '%width' => $config->get('logo.max.width'),
                        '%height' => $config->get('logo.max.height'),
