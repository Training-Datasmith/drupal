...
class PermissionHandlerTest extends UnitTestCase
{
    ...
    public function testBuildPermissionsYaml(): void
    {
        ...
        mkdir($url . '/module_b');
        file_put_contents(
            $url . '/module_b/module_b.permissions.yml',
            <<<EOF
'access module b':
  title: 'Access B'
  description: 'bla bla'
...
EOF
        ...
        mkdir($url . '/module_c');
        file_put_contents(
            $url . '/module_c/module_c.permissions.yml',
            <<<EOF
'access_module_c':
  title: 'Access C'
  description: 'bla bla'
...
EOF
    ...
    public function testBuildPermissionsSortPerModule(): void
    {
        ...
        mkdir($url . '/module_a');
        file_put_contents(
            $url . '/module_a/module_a.permissions.yml',
            <<<EOF
...
EOF
        ...
        $this->assertEquals(
            ['access_module_a4', 'access_module_a1', 'access_module_a2', 'access_module_a3'],
